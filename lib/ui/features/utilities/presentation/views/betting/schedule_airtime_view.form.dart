...
final Map<String, TextEditingController>
    _ScheduledAirtimeViewTextEditingControllers = {};

final Map<String, FocusNode> _ScheduledAirtimeViewFocusNodes = {};

final Map<String, String? Function(String?)?>
    _ScheduledAirtimeViewTextValidations = {
  PhoneValueKey: null,
  AmountValueKey: null,
  FrequencyValueKey: null,
};

mixin $ScheduledAirtimeView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_ScheduledAirtimeViewTextEditingControllers.containsKey(key)) {
      return _ScheduledAirtimeViewTextEditingControllers[key]!;
    }

    _ScheduledAirtimeViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _ScheduledAirtimeViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_ScheduledAirtimeViewFocusNodes.containsKey(key)) {
      return _ScheduledAirtimeViewFocusNodes[key]!;
    }
    _ScheduledAirtimeViewFocusNodes[key] = FocusNode();
    return _ScheduledAirtimeViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _ScheduledAirtimeViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _ScheduledAirtimeViewFocusNodes.values) {
      focusNode.dispose();
    }

    _ScheduledAirtimeViewTextEditingControllers.clear();
    _ScheduledAirtimeViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set phoneValue(String? value) {
    ...
    if (_ScheduledAirtimeViewTextEditingControllers.containsKey(
        PhoneValueKey)) {
      _ScheduledAirtimeViewTextEditingControllers[PhoneValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set amountValue(String? value) {
    ...
    if (_ScheduledAirtimeViewTextEditingControllers.containsKey(
        AmountValueKey)) {
      _ScheduledAirtimeViewTextEditingControllers[AmountValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set frequencyValue(String? value) {
    ...
    if (_ScheduledAirtimeViewTextEditingControllers.containsKey(
        FrequencyValueKey)) {
      _ScheduledAirtimeViewTextEditingControllers[FrequencyValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _ScheduledAirtimeViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _ScheduledAirtimeViewTextEditingControllers[key]!.text,
  );
