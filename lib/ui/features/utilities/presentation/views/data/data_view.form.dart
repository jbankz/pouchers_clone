...
final Map<String, TextEditingController> _DataViewTextEditingControllers = {};

final Map<String, FocusNode> _DataViewFocusNodes = {};

final Map<String, String? Function(String?)?> _DataViewTextValidations = {
  PhoneValueKey: null,
  AmountValueKey: null,
};
...
mixin $DataView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_DataViewTextEditingControllers.containsKey(key)) {
      return _DataViewTextEditingControllers[key]!;
    }

    _DataViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _DataViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_DataViewFocusNodes.containsKey(key)) {
      return _DataViewFocusNodes[key]!;
    }
    _DataViewFocusNodes[key] = FocusNode();
    return _DataViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _DataViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _DataViewFocusNodes.values) {
      focusNode.dispose();
    }

    _DataViewTextEditingControllers.clear();
    _DataViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set phoneValue(String? value) {
    ...
    if (_DataViewTextEditingControllers.containsKey(PhoneValueKey)) {
      _DataViewTextEditingControllers[PhoneValueKey]?.text = value ?? '';
    }
  }
  ...
  set amountValue(String? value) {
    ...
    if (_DataViewTextEditingControllers.containsKey(AmountValueKey)) {
      _DataViewTextEditingControllers[AmountValueKey]?.text = value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _DataViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _DataViewTextEditingControllers[key]!.text,
  );
