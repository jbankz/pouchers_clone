...
final Map<String, TextEditingController> _EducationViewTextEditingControllers =
    {};

final Map<String, FocusNode> _EducationViewFocusNodes = {};

final Map<String, String? Function(String?)?> _EducationViewTextValidations = {
...
mixin $EducationView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_EducationViewTextEditingControllers.containsKey(key)) {
      return _EducationViewTextEditingControllers[key]!;
    }

    _EducationViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _EducationViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_EducationViewFocusNodes.containsKey(key)) {
      return _EducationViewFocusNodes[key]!;
    }
    _EducationViewFocusNodes[key] = FocusNode();
    return _EducationViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _EducationViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _EducationViewFocusNodes.values) {
      focusNode.dispose();
    }

    _EducationViewTextEditingControllers.clear();
    _EducationViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set providerValue(String? value) {
    ...
    if (_EducationViewTextEditingControllers.containsKey(ProviderValueKey)) {
      _EducationViewTextEditingControllers[ProviderValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set subscriptionTypeValue(String? value) {
    ...
    if (_EducationViewTextEditingControllers.containsKey(
        SubscriptionTypeValueKey)) {
      _EducationViewTextEditingControllers[SubscriptionTypeValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set amountValue(String? value) {
    ...
    if (_EducationViewTextEditingControllers.containsKey(AmountValueKey)) {
      _EducationViewTextEditingControllers[AmountValueKey]?.text = value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _EducationViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _EducationViewTextEditingControllers[key]!.text,
  );
