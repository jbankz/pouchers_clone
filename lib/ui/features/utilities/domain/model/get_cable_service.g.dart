...
class GetCableServiceAdapter extends TypeAdapter<_$GetCableServiceImpl> {
  @override
  final int typeId = 13;

  @override
  _$GetCableServiceImpl read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$GetCableServiceImpl(
  ...
  @override
  void write(BinaryWriter writer, _$GetCableServiceImpl obj) {
    writer
      ..writeByte(2)
      ..writeByte(0)
