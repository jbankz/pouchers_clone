...
mixin _$Data {
  ...
  dynamic get referralCode => throw _privateConstructorUsedError;
...
class _$DataImpl implements _Data {
  ...
  @override
  String toString() {
    return 'Data(userId: $userId, firstName: $firstName, lastName: $lastName, email: $email, phoneNumber: $phoneNumber, status: $status, tierLevels: $tierLevels, tag: $tag, referralCode: $referralCode)';
  }
...
abstract class _Data implements Data {
  factory _Data(
      ...
      final dynamic tag,
      @JsonKey(name: 'referral_code') final dynamic referralCode}) = _$DataImpl;
