...
class _$BannerImpl implements _Banner {
  _$BannerImpl(
      {@HiveField(0) this.id,
      @JsonKey(name: 'image_url') @HiveField(1) this.imageUrl,
  ...
  @override
  String toString() {
    return 'Banner(id: $id, imageUrl: $imageUrl, type: $type)';
  }
...
abstract class _Banner implements Banner {
  factory _Banner(
      ...
      @JsonKey(name: 'image_url') @HiveField(1) final String? imageUrl,
      @HiveField(2) final String? type}) = _$BannerImpl;
