...
import '../read_all_notification_usecase.dart';
...
final readAllNotificationUseCaseModule = Provider<PoucherUseCaseWithOutParam>(
    (ref) => ReadAllNotificationUseCaseImpl(ref.read(notificationRepoModule)));
