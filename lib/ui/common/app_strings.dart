class AppString {
  ...
  static String joinPouchers = "Join Pouchers";
  static String joinPouchers1 = "Create an account or login to get cool";
  static String joinPouchers2 = " deals and discounts ";
  static String joinPouchers3 =
      "on airtime, data, internet, betting and many other bill purchases.";
  static String createAccountText = "Create an Account";
  static String guestEnterEmail =
  ...
  static String verifyAccountCode = "Verify Code";
  static String createTag = "Create Tag";
  ...
  static String byCreatingAccount =
  ...
  static String loginSubText = "Enter your details to login";
  static String forgotPasswordSubText =
