...
class CardsRepository {
  ...
  Future<NotifierState<String>> createVirtualCards({required String address,
  ...
  Future<NotifierState<String>> fundVirtualCard({required String type,
    required double amount,
    required String transactionPin}) async {
    final accessToken = await getAccessToken();
  ...
  Future<NotifierState<String>> getCardToken(
      {required cardId}) async {
    final accessToken = await getAccessToken();
  ...
  Future<NotifierState<String>> freezeCard({required String cardId,
