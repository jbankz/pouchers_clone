...
class EducationSummary extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EducationSummary> createState() => _RechargeSummaryState();
}

class _RechargeSummaryState extends ConsumerState<EducationSummary> {
  ...
  void initState() {
    ...
    getUserCred();
    setState(() {
      failedAttempts = SessionManager.getFailedAttempt() ?? 0;
    });
  }
