                              ...
                              children: [
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          errorWidget: (context, url, error) =>
                                              widget.request.profilePicture !=
                                                  ...
                                                  : Center(
                                                      child: Text(
                                                          "${widget.request.firstName!.substring(0, 1).toUpperCase()}${widget.request.lastName!.substring(0, 1).toUpperCase()}",
                                                          style: textTheme
                                                              .bodyText2!
                                                              .copyWith(
                                                                  fontSize:
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "${widget.request.firstName.toString().toTitleCase2()} ${widget.request.lastName.toString().toTitleCase2()} is Requesting",
                                        ...
                                        widget: Column(
                                          children: [
                                            RichText(
                                              text: TextSpan(
                                                  text:
                                                      "You are about to decline the request of ",
                                                  style: TextStyle(
                                                    color: kIconGrey,
                                                    fontWeight:
                                                        FontWeight.normal,
                                                  ...
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                        text:
                                                            "${widget.request.firstName.toString().toTitleCase2()} ${widget.request.lastName.toString().toTitleCase2()}.",
                                                        style: textTheme
                                                            .headline4!
                                                            .copyWith(
                                                          fontSize: 16,
                                        ...
                                        if (ref
                                          ...
                                          if (cred?.transactionPin == null ||
                                            ...
                                            if (result != null) {
                                              ref
                                                  .read(
                                                      moneyRequestStatusProvider
                                                          .notifier)
                                                  .moneyRequestStatus(
                                                      action: "decline",
                                                      note: declineController
                                                          .text,
                                                      amount: double.parse(
                                                          "${wholeText}.${decimalText}"),
                                                      requestId: widget
